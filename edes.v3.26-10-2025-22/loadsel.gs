...
if( mb_substr($CampoACargar,0,3)=='cd_' ){
$Tabla = mb_substr($CampoACargar,3);
$Orden = 'nm_'.$Tabla;
}
...
echo '</HEAD><BODY>';
echo '<TABLE border=0px class="col_0n col_1l" style="cursor:var(--cPointer)" onclick="elSelUpdate()" cellspacing=1px cellpadding=1px>';
echo '<col id=o><col>';
$ConBlanco = false;
