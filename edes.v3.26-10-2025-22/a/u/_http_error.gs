...
'<FORM accept-charset="utf-8" METHOD=POST ACTION="edes.php?E:$a/u/_http_error.gs">';
...
<?PHP
echo '<br><bt><center>';
echo eLng('Código de actualización').': <b onclick=window.clipboardData.setData("Text","'._IDSRV().'") style="cursor:var(--cPointer)">'._IDSRV().'</b>';
echo '</center>';
echo '</BODY></HTML>';
eEnd();
}
