...
if( mb_substr($Path,0,2)==REM ) $Path = mb_substr($Path,1);
if( mb_substr($Path,-1)!='/' ) $Path .= '/';
if( mb_substr($PathFileManager,-1)!='/' ) $PathFileManager .= '/';
?>
</style>
...
<td style='cursor:var(--cAuto)' id=TxtRecortes>&nbsp;Recortes:&nbsp;</td>
<td style='cursor:var(--cAuto)' id=TotRecortes style='padding-right:3'>0</td>
</tr>
</table>
</td></tr>
