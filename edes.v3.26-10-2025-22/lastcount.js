...
var s = S.screen(window),
nd = DGI('DimRecuentos'), tr,td;
if( s.h<(nd.offsetHeight+nd.rows[0].offsetHeight) ){
S("TR", nd).each(function(k,o){
if( k>0 && o.offsetHeight>0 ){
S(o).none();
return null;
}
});
