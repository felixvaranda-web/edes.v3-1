...
if( $CopiarComo=="" ){
$NomPDF = "/_tmp/pdf/screen_".S::$_User.".pdf";
$oNomPDF = $NomPDF;
if( WINDOW_OS ){
...
$d = $dim[$n];
switch( trim(mb_strtoupper($d[tagName])) ){
case "EDES":
