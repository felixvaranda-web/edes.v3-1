...
$numbers = SETUP::$CSSDynamic['FontNumbers'];
$fBase = trim($fBase);
...
$txt .= "\n";
$txtAdd = file_get_contents(DIREDES."width_add.txt");
...
if( $NEXT=="END" ){
echo "top.S.ok('Cálculo de anchos generados');";
}else{
?>
location.replace("edes.php?E:$t/create_css_ini.php&_NEXT='<?=$NEXT?>'&_SESS_=<?=$_SESSION['_SESS_']?>");
<?PHP
}
echo "</script>";
exit;
...
echo "top.S.info('Calculando anchos...');";
...
INPUT[TD='DC']
{
font-family:<?=SETUP::$CSSDynamic['FontNumbers']?>;
}
<?PHP
echo "</style>";
...
$randCero = "";
for($n=0; $n<2000; $n++){
$randUpper .= mb_chr(rand(65,90));
$randLower .= mb_chr(rand(97,122));
$randNum   .= mb_chr(rand(48,57));
$randCero  .= "0";
}
?>
...
echo '<br>';
echo "<input type=text class=EDITABLE TD=T value='".SETUP::$System["_FormatT"]."' {$StyleNumber}>";
echo '<br>';
...
echo '<br>';
?>
<FORM accept-charset="utf-8" METHOD=POST action="edes.php?E:$t/create_css_ini.php&_NEXT=<?=$NEXT.'&_SESS_='.$_SESSION['_SESS_']?>" style="display:none">
...
if( _DimColsWidth["T"]["H"]=="auto" ){
alert("ERROR en el fichero /_datos/config/width_css.php<br>_DimColsWidth['T']['H'] = auto");
}
...
_DimColsWidth["L"]['F4']  += 1;
_DimColsWidth["L"]['P4']  += 1;
_DimColsWidth["L"]['CDI'] += 1;
_DimColsWidth["L"]['CP']  += 1;
_DimColsWidth["L"]['H8']  += 1;
_DimColsWidth["L"]['H5']  += 1;
_DimColsWidth["L"]['H2']  += 1;
_DimColsWidth["L"]['DC']  += 1;
_DimColsWidth["L"]['T']   += 1;
_DimColsWidth["L"]['CLR'] += 1;
_DimColsWidth["L"]['clr'] += 1;
_DimColsWidth["L"]['IP']  += 1;
_DimColsWidth["L"]['DNI'] += 1;
_DimColsWidth["L"]['NIF'] += 1;
_DimColsWidth["L"]['nif'] += 1;
_DimColsWidth["L"]['CIF'] += 1;
_DimColsWidth["L"]['cif'] += 1;
_DimColsWidth["L"]['NSS'] += 1;
