...
echo "<tr style='background-color:#{$color};color:".eColorContrastBW2($color)."'><td>".mb_substr($label,1)."<td style='{$oldColor}'>".$color;
}
}
echo '</table>';
echo '</table>';
