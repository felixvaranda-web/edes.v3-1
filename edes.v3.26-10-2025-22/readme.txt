...
PASOS A SEGUIR CON UN MODELO COMPATIBLE UTILIZANDO LA DISTRIBUCION XAMPP:
	...
	- Para instalar la licencia hay que añadir la siguiente linea
		zend_optimizer.license_path = "c:\xampp\htdocs\edes.v3\license_edes.zl" ; El fichero de licencia se encuentra dentro del directorio raiz de edes.v3.
...
3- INSTALAR E-DES.
	...
	- Descomprimir el fichero edes.v3.zip en un directorio dentro de "c:\web\apache\htdocs" se creara un directorio "c:\xampp\apache\htdocs\edes.v3".
...
4- ARRANCAR "gsCreate" PARA CONFIGURAR Y CREAR UNA INTRANET NUEVA.
	...
	- Para ejecutar "gsCreate" hay que entrar en la aplicación "edesweb" llamando a http://localhost//edes.v3/ttp/edes.php?gscreate
