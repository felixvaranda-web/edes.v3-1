...
function _PF(){
$p1 = func_get_arg(1);
if( gettype($p1)=="string" && ($p1=="" || eSubstrCount($p1, "WOPENER")>0) && gettype(func_get_arg(0))=="array" ){
if( $p1<>"" && mb_substr($p1,-1)<>"." ) $p1.=".";
echo $p1."ePF({";
$n=0;
...
if( preg_match("/^SELECT /iu", $dim[$n][$i]) ){
$sql = $dim[$n][$i];
}else{
