...
if( $_SESSION['txt_private']!=$_ENV['ON'] && $_SESSION['txt_public']!=$_ENV['ON'] ) eEnd();
...
if( mb_strtoupper($_PDFCOL[$n])=='TXT' ) $Visible[$n] = true;
if( mb_substr($_Form[$n][4],0,2)=="-1" ) $_Form[$n][4] = 2000;
$_ALIGN[$n] = trim(str_replace('id=','',$_ALIGN[$n]));
