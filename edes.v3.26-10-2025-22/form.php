...
oc = S(obj).xy(),
x,y,h;
if( event.ctrlKey || event.altKey ) conForm = true;
...
break;
case "rect":
if( conForm || event.ctrlKey || event.altKey ){
...
var n1 = desplazaUno(obj.which, dis=(event.ctrlKey || event.altKey?10:1), _ObjAMover);
if( n1!=null && /^(CrearLineaDeCorte|Tijeras)$/.test(_ObjAMover.id) ){
o = SuElementoAsociado(_ObjAMover, y);
desplazaUno(obj.which, dis=(event.ctrlKey || event.altKey?10:1), o);
}
}
}
...
<?PHP
include(DIREDES."itm/etoneselect.js");
include(DIREDES."ed.js");
$nombreImpreso = "";
$_HojaAncho = 630;
$_HojaAlto = 891;
$eHoja = "A4,V,630,891";
...
SS::query("select * {$_ENV['SYSDB']}form where cd_gs_form={$cd_gs_form} && cd_gs_node={$_Node}");
$r = SS::get();
...
<tr><td onclick="CrearMultilinea(this)" id="idMultilinea" oncontextmenu="CrearConForm('M','.anchoalto,.lapizpapel,.sizegrueso,.fuentestilo',':v_papel,:v_font_weight_label,:v_font_style_label')"><i class="ICONWINDOW">&#314;</i> Texto horizontal</td></tr>
...
<br>
<form accept-charset="utf-8" name=FRM1>
<table class="BROWSE" border="0px" cellspacing="0px" cellpadding="0px">
...
<input name="font_style_label" value="Normal" class="READONLY" readonly="true" onclick="" leng="15" maxlength="15" size="15" onchange="uDefault(this,'Helvetica')" onfocus="S.key('#',15,0)" tc="#" style="cursor:var(--cAuto); width:100px;">
...
<input name="font_weight_label" value="Normal" class="READONLY" readonly="true" onclick="" leng="15" maxlength="15" size="15" onchange="uDefault(this,'Helvetica')" onfocus="S.key('#',15,0)" tc="#" style="cursor:var(--cAuto); width:100px;">
...
<input name="hoja" value="<?=$eHojaLabel?>" class="READONLY" readonly="true" onclick="" leng="15" maxlength="15" size="15" onfocus="S.key('#',15,0)" tc="#" style="cursor:var(--cAuto);width:100px;">
...
<input name="font_family_label" value="Helvetica" class="READONLY" readonly="true" onclick="" leng="15" maxlength="15" size="15" onchange="uDefault(this,'Helvetica')" onfocus="S.key('#',15,0)" tc="#" style="cursor:var(--cAuto); width:100px;">
...
<input name="ver_label" value="Si" class="READONLY" readonly="true" onclick="" leng="2" maxlength="2" size="2" style="cursor:var(--cAuto); width:100px;">
</td></tr>
<?PHP } ?>
<?PHP
if( $_SESSION["_D_"]!="" ){
...
<form accept-charset="utf-8" name="FRM3">
...
<i class="ICONWINDOW CHECKOFF" style="font-family:eDes" onclick="CerrarRejilla()">i</i>
<i class="ICONWINDOW CHECKON" style="font-family:eDes;margin-left:10px;" onclick="AceptarRejilla()">j</i>
</table>
</form>
</span>
...
<form accept-charset="utf-8" name="FRM2">
<table style="display:table" border="0px" cellspacing="0px" cellpadding="0px">
<tr>
...
<td>
<input name="v_font_weight_label" onclick="BoldDeLetra(this)" value="Normal" class="READONLY" readonly="true" onclick="" leng="15" maxlength="15" size="15" onchange="uDefault(this,'Helvetica')" onfocus="S.key('#',15,0)" tc="#" style="cursor:var(--cAuto); width:70px;">
<input name="v_font_weight" value="normal" style="display:none">
</td>
<tr class="fuentestilo">
<td align=right>Tipo letra</td>
<td>
<input name="v_font_family_label" onclick="TipoDeLetra(this)" value="Helvetica" class="READONLY" readonly="true" onclick="" leng="15" maxlength="15" size="15" onchange="uDefault(this,'Helvetica')" onfocus="S.key('#',15,0)" tc="#" style="cursor:var(--cAuto); width:70px;">
<input name="v_font_family" value="Helvetica" style="display:none">
</td>
<td align=right>Estilo letra</td>
<td>
<input name="v_font_style_label" onclick="EstiloDeLetra(this)" value="Normal" class="READONLY" readonly="true" onclick="" leng="15" maxlength="15" size="15" onchange="uDefault(this,'Helvetica')" onfocus="S.key('#',15,0)" tc="#" style="cursor:var(--cAuto); width:70px;">
<input name="v_font_style" value="normal" style="display:none">
</td>
<tr class="solotexto">
<td align=right>Texto</td>
<td colspan=3>
<input name="v_texto" value="" class="EDITABLE" readonly="true" onclick="" leng="15" maxlength="15" size="15" onchange="uDefault(this,'Helvetica')" onfocus="S.key('#',265,0)" tc="#" style="cursor:var(--cAuto); width:100%;">
</td>
<tr>
...
<td style="width:100%">
<td onclick="CancelarFormulario()"><span class="AddButton"><i class="ICONWINDOW CHECKOFF" style="font-style:normal;font-family:eDes;font-weight:bold;">i</i> Cancelar</span>
<td onclick="AceptarFormulario()"><span class="AddButton" style="margin-left:15px;"><i class="ICONWINDOW CHECKON" style="font-style:normal;font-family:eDes;font-weight:bold;">j</i> Aceptar</span>
</table>
</table>
</form>
</span>
