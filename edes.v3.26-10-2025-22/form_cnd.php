...
<th style="width:100%;background:transparent;white-space:nowrap;cursor:var(--cAuto)">Condición multiple</th>
...
<tr><td>
<form accept-charset="utf-8" name="GETCONDITION">
<table class="BROWSE NO_SHADOW" style="border-collapse:separate;">
<tr style="cursor:var(--cAuto)"><th style="cursor:var(--cAuto)">Condición</th><th style="cursor:var(--cAuto)">Valor</th></tr>
<tr>
<td align="center">
